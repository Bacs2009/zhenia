...
function identity(){
	...
	setTimeout(function() {
		$(".bgslider").empty().css({"background-image":"url(img/bgslider.png)","width":"900px","height":"630px","left":"15%","right":"15%"}).animate({top:'15%'},500, correctSliders());
		...
		.append('<div class="back_identity" title="Back to Websites"></div>')
		.append('<div class="next_identity" title="Go to Others"></div>');
