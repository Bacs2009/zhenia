...
function other(){
	...
	setTimeout(function() {
		...
		.append('<div id="strelka" class="other_left_strelka" title="Back to Identity"></div>')
		...
		.append('<div id="strelka_right" class="other_right_strelka" title="Go to Poligraphy"></div>')
	...
	$(".bgslider").on("click", "#strelka", function(){
		location.hash = "#identity";
	});
	$(".bgslider").on("click", "#strelka_right", function(){
...
function animateBgslider(){
	...
	$(".other_left_top_oliva").delay(700).fadeIn(50).animate({marginTop:"-10.5em", marginLeft:"-30em"},{duration:'50'});
